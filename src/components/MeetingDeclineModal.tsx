...
interface MeetingDeclineModalProps {
  visible: boolean;
  onClose: () => void;
  onSend: (reason: string) => void;
}

export default function MeetingDeclineModal({
  visible,
  onClose,
  onSend,
  ...
  // Keyboard event listeners - separate animated value for keyboard
  useEffect(() => {
    if (!visible) return;
    ...
    const keyboardWillShow = Keyboard.addListener(
      ...
      (e) => {
        ...
        // Focus input and scroll to it after keyboard animation
        setTimeout(
          () => {
  ...
  // Combine translateY and keyboardOffset for final position
          ...
          <SafeAreaView edges={["bottom"]} style={styles.safeArea}>
            ...
            <View style={styles.contentContainer}>
              ...
              <Text style={styles.title}>
                Tell us why you are declining your meeting?
              </Text>
