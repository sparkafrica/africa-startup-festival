  ...
  expo: {
    ...
    extra: {
      ...
      UPGRADE_CLASS_ID_OASIS: process.env.EXPO_PUBLIC_UPGRADE_CLASS_ID_OASIS
        ...
        : undefined,
      UPGRADE_CLASS_ID_DELEGATE: process.env.EXPO_PUBLIC_UPGRADE_CLASS_ID_DELEGATE
        ? parseInt(process.env.EXPO_PUBLIC_UPGRADE_CLASS_ID_DELEGATE, 10)
        : undefined,
      UPGRADE_CLASS_ID_CHAIRPERSON: process.env.EXPO_PUBLIC_UPGRADE_CLASS_ID_CHAIRPERSON
        ? parseInt(process.env.EXPO_PUBLIC_UPGRADE_CLASS_ID_CHAIRPERSON, 10)
        : undefined,
      UPGRADE_PAYMENT_METHOD: process.env.EXPO_PUBLIC_UPGRADE_PAYMENT_METHOD || "free",
